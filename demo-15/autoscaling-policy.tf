...
resource "aws_cloudwatch_metric_alarm" "example_cpu_alarm_scaleup" {
  alarm_name          = "example_cpu_alarm_scaleup"
  alarm_description   = "example_cpu_alarm_scaleup"
...
resource "aws_cloudwatch_metric_alarm" "example_cpu_alarm_scaledown" {
  alarm_name          = "example_cpu_alarm_scaledown"
  alarm_description   = "example_cpu_alarm_scaledown"
